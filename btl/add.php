                ...
                <div class="admin-interac-one frames">
                    ...
                    <div class="col-md-8 col-lg-8">
                        <form class="form" action="add_exec.php" method="post"  enctype="multipart/form-data">
                            ...
                            <div class="clear-both"></div>
                            <label> Name</label><input name="name" value=""/>
                            <div class="clear-both"></div>
                            <label>Price</label><input name="price" value=""/>
                            <div class="clear-both"></div>
                            <label>Address</label><input name="address" value=""/>
                            <div class="clear-both"></div>
                            <label>Number-Sold</label><input name="nbsold"/>
                            <div class="clear-both"></div>
