...
<body>
    <div class="m-wapper">
        ...
        <div class="content">
            ...
            <h4>
                <div class="admin-interac-one frames">
                    <br>
                    <div class="col-md-8 col-lg-8">
                        <form class="form" action="edit_exec.php" method="post"  enctype="multipart/form-data">
                            ...
                            <?php foreach ($cates as $item) {?>
                                ...
                                <option value="<?php echo $item["id"]?>" <?php if ($item["id"] == $datas["cid"]){?>selected<?php } ?>><?php echo $item["name"]?></option>
                            <?php } ?>
                            </select>
                            <div class="clear-both"></div>
                            <label>Image</label>
                            <!-- <input type="file" name="img" value=""/> -->
                            <input name="img" type="file" value="<?php echo $datas["img"]?>"/>

                                <img src="<?php echo $datas["img"]?>"/>

                            <div class="clear-both"></div>
                            <label>Name</label><input name="name" value="<?php echo $datas["name"] ?>"/>
                            <div class="clear-both"></div>
                            <label>Price</label><input name="price" value="<?php echo $datas["price"]?>"/>
                            <div class="clear-both"></div>
                            <label>Address</label><input name="address" value="<?php echo $datas["address"]?>"/>
                            <div class="clear-both"></div>
                            <label>Number-Sold</label><input name="nbsold" value="<?php echo $datas["nbsold"]?>"/>
                            <div class="clear-both"></div>
