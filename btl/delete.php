            ...
            <div class="admin-interac-one frames">
                ...
                <div class="col-md-8 col-lg-8">
                    <form class="form" action="delete_exec.php" method="post"  enctype="multipart/form-data">
                        ...
                        <label>
                            Image:
                        </label><input name="img" value="<?php echo $pros['img']?>"/>
                            <img src="<?php echo $pros['img']?>" alt="">
                        <div class="clear-both"></div>
                        <label>
                            Name:
                        </label><?php echo $pros['name']?>
                        <div class="clear-both"></div>
                        <label>
                            Price
                        </label><input name="price" value="<?php echo $pros['price']?>"/>
                        <div class="clear-both"></div>
                        <label>
                            Address
                        </label><input name="address" value="<?php echo $pros['address'] ?>"/>
                        <div class="clear-both"></div>
                        <label>
                            Number-Sold
                        </label><input name="nbsold" value="<?php echo $pros['nbsold']?>"></input>
                        <div class="clear-both"></div>
